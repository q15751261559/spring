...
INSERT INTO `admin` VALUES ('root', 'root', 2);
...
INSERT INTO `book_store` VALUES (1, 6);
INSERT INTO `book_store` VALUES (1, 9);
INSERT INTO `book_store` VALUES (1, 3);
INSERT INTO `book_store` VALUES (1, 1);
INSERT INTO `book_store` VALUES (1, 12);
INSERT INTO `book_store` VALUES (1, 24);
...
-- ----------------------------
INSERT INTO `borrow_books` VALUES (21, 1, 6, '2020-04-08 09:37:40', '2020-06-08 09:38:14', '2020-06-11 10:50:07', '已逾期3天', 'chen');
INSERT INTO `borrow_books` VALUES (22, 1, 1, '2020-06-11 09:47:44', '2020-08-10 09:47:52', '2021-05-30 19:17:06', '', 'chen');
...
INSERT INTO `borrow_books` VALUES (28, 1, 2, '2020-04-07 10:12:28', '2020-06-06 10:12:41', '2021-05-30 19:51:05', NULL, NULL);
INSERT INTO `borrow_books` VALUES (29, 1, 4, '2020-06-11 08:19:56', '2020-06-12 08:20:07', '2021-05-30 19:48:22', NULL, NULL);
INSERT INTO `borrow_books` VALUES (30, 1, 1, '2021-05-30 19:18:54', NULL, '2021-05-30 19:19:09', NULL, NULL);
INSERT INTO `borrow_books` VALUES (31, 1, 1, '2021-05-30 19:59:43', NULL, '2021-05-30 19:59:49', NULL, NULL);
INSERT INTO `borrow_books` VALUES (32, 1, 1, '2021-05-30 19:59:55', NULL, '2021-05-30 22:56:28', NULL, NULL);
INSERT INTO `borrow_books` VALUES (33, 1, 12, '2021-05-30 20:00:00', NULL, '2021-05-30 22:55:53', NULL, NULL);
INSERT INTO `borrow_books` VALUES (34, 1, 13, '2021-05-30 22:55:57', NULL, '2021-05-30 22:56:00', NULL, NULL);
INSERT INTO `borrow_books` VALUES (35, 1, 13, '2021-05-30 22:56:03', NULL, NULL, NULL, NULL);
INSERT INTO `borrow_books` VALUES (36, 1, 1, '2021-05-30 22:58:59', NULL, NULL, NULL, NULL);
INSERT INTO `borrow_books` VALUES (37, 1, 24, '2021-05-30 23:00:10', NULL, '2021-05-30 23:00:11', NULL, NULL);
...
CREATE TABLE `borrow_card`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1805010221 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of borrow_card
-- ----------------------------
INSERT INTO `borrow_card` VALUES (1, 'root', '老王', 7, 1, '123', '/', '活泼开朗、乐观向上、兴趣广泛、适应力强、上手快、勤奋好学、脚踏实地、认真负责、坚毅不拔、吃苦耐劳、勇于迎接新挑战。', '15251711139', '123@niit.edu.cn', 0);
...
INSERT INTO `borrow_card` VALUES (12, '1234', '小红', 1, 1, '1805010214', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `borrow_card` VALUES (13, '赵雪', '赵雪', 2, 1, '1805010217', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `borrow_card` VALUES (14, '1234', '测试', 1, 0, '1805010219', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `borrow_card` VALUES (1805010219, '456', '马千', 4, 1, '456', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `borrow_card` VALUES (1805010220, '123', '小虎', 1, 1, 'wang', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `message`  (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `reader` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (1, '老王', '冲鸭，一起来看书', '2020-06-01 23:11:59');
INSERT INTO `message` VALUES (2, '老王', '我爱学习', '2020-05-29 23:12:03');
INSERT INTO `message` VALUES (3, '老王', '图书馆的书质量很好，图书管理员态度非常好，系统管理员也非常热心，太棒了', '2020-06-04 23:12:24');
INSERT INTO `message` VALUES (6, '老王', '咋回事', '2020-06-12 08:34:18');
INSERT INTO `message` VALUES (7, '老王', '整挺好', '2021-05-28 22:19:04');
INSERT INTO `message` VALUES (8, '老王', '软件2048', '2021-05-28 22:38:44');
INSERT INTO `message` VALUES (9, '123', '<p>你们好啊<img src=\"http://localhost:8080/layui/images/face/4.gif\" alt=\"[鍙�淽\"></p>', '2021-05-29 01:13:36');
INSERT INTO `message` VALUES (10, '123', '好好学习天天向上<img src=\"http://localhost:8080/layui/images/face/26.gif\" alt=\"[鎬抅\">', '2021-05-29 01:17:38');
INSERT INTO `message` VALUES (11, '老王', '我们611是团结的宿舍<img src=\"http://localhost:8080/layui/images/face/60.gif\" alt=\"[绁為┈]\">', '2021-05-29 01:52:03');
INSERT INTO `message` VALUES (12, '老王', 'donggepa', '2021-05-29 12:49:01');
INSERT INTO `message` VALUES (13, '老王', '李俊杰是一个', '2021-05-29 15:20:55');
